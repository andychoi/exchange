...
$DomainsToExclude = ("doamin1.com", "domain2.com")
$galTemp,$galTempp,$galTempfinal = [System.Collections.ArrayList]@()
$onpremisesConnectionUri = "https://owa.hisna.com/powershell"
...
Function auth_OnPremises {
    ...
    #$Session = New-PSSession -ConfigurationName Microsoft.Exchange -ConnectionUri $onpremisesConnectionUri -Authentication Kerberos -AllowRedirection -AllowClobber -DisableNameChecking
    ...
    ForEach ($type in $RecipientTypes) {
        ...
        Switch ($type) {
            UserMailbox {
                ...
                Set-AdServerSettings -ViewEntireForest $True
                $galTemp = Get-mailbox -ResultSize 30 -WarningAction SilentlyContinue -ErrorAction SilentlyContinue | ? { ($_.Alias -notmatch "DiscoverySearchMailbox") -and ($_.PrimarySmtpAddress -notmatch $regexdomain) -and ($_.OrganizationalUnit -notmatch 'HKEnterprise.*Disabled-Accounts') } | Select Alias, DisplayName, @{n = "EmailAddresses"; e = { $_.EmailAddresses -join ";" } }, ExternalEmailAddress, FirstName, HiddenFromAddressListsEnabled, LastName, LegacyExchangeDn, Name, PrimarySmtpAddress, RecipientType, @{n = "Phone"; e = {""}}, @{n = "MobilePhone"; e = {""}}, @{n = "Company"; e = {""}}, @{n = "Title"; e = {""}}, @{n = "Department"; e = {""}}, @{n = "Office"; e = {""}}, guid
                $galTempp += finaluserprop($galTemp)
            }
            MailUser {
                Write-Host "    Exporting MailUser" -ForegroundColor Yellow
                Set-AdServerSettings -ViewEntireForest $True
                $galTemp = Get-MailUser -Resultsize 30 -WarningAction SilentlyContinue -ErrorAction SilentlyContinue | ? { ($_.Alias -notmatch "DiscoverySearchMailbox") -and ($_.PrimarySmtpAddress -notmatch $regexdomain) } | Select Alias, DisplayName, @{n = "EmailAddresses"; e = { $_.EmailAddresses -join ";" } }, ExternalEmailAddress, FirstName, HiddenFromAddressListsEnabled, LastName, LegacyExchangeDn, Name, PrimarySmtpAddress, RecipientType, @{n = "Phone"; e = {""}}, @{n = "MobilePhone"; e = {""}}, @{n = "Company"; e = {""}}, @{n = "Title"; e = {""}}, @{n = "Department"; e = {""}}, @{n = "Office"; e = {""}}, guid
                $galTempp += finaluserprop($galTemp)
            }
            MailContact {
                Write-Host "    Exporting MailContacts" -ForegroundColor Yellow
                Set-AdServerSettings -ViewEntireForest $True
                $galTempp += Get-MailContact -ResultSize 30 -WarningAction SilentlyContinue -ErrorAction SilentlyContinue | ? { ($_.Alias -notmatch "DiscoverySearchMailbox") -and ($_.PrimarySmtpAddress -notmatch $regexdomain) } | Select Alias, DisplayName, @{n = "EmailAddresses"; e = { $_.EmailAddresses -join ";" } }, ExternalEmailAddress, FirstName, HiddenFromAddressListsEnabled, LastName, LegacyExchangeDn, Name, PrimarySmtpAddress, RecipientType, @{n = "Phone"; e = {""}}, @{n = "MobilePhone"; e = {""}}, @{n = "Company"; e = {""}}, @{n = "Title"; e = {""}}, @{n = "Department"; e = {""}}, @{n = "Office"; e = {""}}, guid
            }
            MailUniversalSecurityGroup {
                Write-Host "    Exporting MailUniversalSecurityGroup" -ForegroundColor Yellow
                Set-AdServerSettings -ViewEntireForest $True
                $galTempp += Get-DistributionGroup -RecipientTypeDetails MailUniversalSecurityGroup -ResultSize 30 -WarningAction SilentlyContinue -ErrorAction SilentlyContinue | ? { ($_.Alias -notmatch "DiscoverySearchMailbox") -and ($_.PrimarySmtpAddress -notmatch $regexdomain) } | Select Alias, DisplayName, @{n = "EmailAddresses"; e = { $_.EmailAddresses -join ";" } }, ExternalEmailAddress, FirstName, HiddenFromAddressListsEnabled, LastName, LegacyExchangeDn, Name, PrimarySmtpAddress, RecipientType, @{n = "Phone"; e = {""}}, @{n = "MobilePhone"; e = {""}}, @{n = "Company"; e = {""}}, @{n = "Title"; e = {""}}, @{n = "Department"; e = {""}}, @{n = "Office"; e = {""}}, guid
            }
            MailUniversalDistributionGroup {
                Write-Host "    Exporting MailUniversalDistributionGroup" -ForegroundColor Yellow
                Set-AdServerSettings -ViewEntireForest $True
                $galTempp += Get-DistributionGroup -RecipientTypeDetails MailUniversalDistributionGroup -ResultSize 30 -WarningAction SilentlyContinue -ErrorAction SilentlyContinue | ? { ($_.Alias -notmatch "DiscoverySearchMailbox") -and ($_.PrimarySmtpAddress -notmatch $regexdomain) } | Select Alias, DisplayName, @{n = "EmailAddresses"; e = { $_.EmailAddresses -join ";" } }, ExternalEmailAddress, FirstName, HiddenFromAddressListsEnabled, LastName, LegacyExchangeDn, Name, PrimarySmtpAddress, RecipientType, @{n = "Phone"; e = {""}}, @{n = "MobilePhone"; e = {""}}, @{n = "Company"; e = {""}}, @{n = "Title"; e = {""}}, @{n = "Department"; e = {""}}, @{n = "Office"; e = {""}}, guid
            }
            RemoteUserMailbox{
                Write-Host "    Exporting RemoteMailboxes" -ForegroundColor Yellow
                Set-AdServerSettings -Vieget-remwEntireForest $True
                $galTemp = Get-RemoteMailbox -resultsize 30 -WarningAction SilentlyContinue -ErrorAction SilentlyContinue | ? { ($_.Alias -notmatch "DiscoverySearchMailbox") -and ($_.PrimarySmtpAddress -notmatch $regexdomain) } | Select Alias, DisplayName, @{name = "EmailAddresses"; e = { $_.EmailAddresses -join ";" } }, @{Name = "ExternalEmailAddress";Expression={$(($_.RemoteRoutingAddress).SmtpAddress)}}, FirstName, HiddenFromAddressListsEnabled, LastName, LegacyExchangeDn, Name, PrimarySmtpAddress, @{n = "RecipientType"; e = {$_.RecipientTypeDetails}}, @{n = "Phone"; e = {""}}, @{n = "MobilePhone"; e = {""}}, @{n = "Company"; e = {""}}, @{n = "Title"; e = {""}}, @{n = "Department"; e = {""}}, @{n = "Office"; e = {""}}, guid
                $galTempp += finaluserprop($galTemp)
            }
...
function import () {
    ...
    If ($RecipientTypes) {
        ...
        $SourceGAL = Import-Csv $outputcsv | ? { $_.RecipientType -match $RecipientTypeFilter }
    }
    else {
        $SourceGAL = Import-Csv $outputcsv -Delimiter "," -Encoding UTF8
    }
